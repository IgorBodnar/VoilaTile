namespace VoilaTile.Snapper.Services
{
    ...
    /// <summary>
    /// Enumerates top-level windows according to the supplied <see cref="WindowQueryOptions"/> and
    /// returns a snapshot of matching <see cref="WindowEntry"/> records.
    /// </summary>
    internal sealed class WindowEnumerator : IWindowEnumerator
    {
        ...
        /// <summary>
        /// Set of window class names that should be excluded from enumeration results.
        /// </summary>
        ...
        /// <summary>
        /// Enumerates all windows and returns those that satisfy the provided <paramref name="options"/>.
        /// </summary>
        /// <param name="options">Filtering and behavior options for window enumeration.</param>
        /// <returns>A read-only list of <see cref="WindowEntry"/> records describing the matched windows.</returns>
