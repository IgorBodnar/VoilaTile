namespace VoilaTile.Settings.ViewModels
{
    ...
    public partial class LayoutEditorViewModel : ObservableObject
    {
        ...
        /// <summary>
        /// The minimum tile dimension in pixels.
        /// </summary>
        const int MinimumTileDimensionPixel = 200;

        /// <summary>
        /// The threshold in pixels for snapping dividers together.
        /// </summary>
        const int DividerSnapInThresholdPixel = 10;

        /// <summary>
        /// The threshold in pixels for unsnapping dividers.
        /// </summary>
        const int DividerSnapOutThresholdPixel = 20;

        /// <summary>
        /// The zone template being edited.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the layout editor view model.
        /// </summary>
        ...
        /// <summary>
        /// Gets the edited zone template.
        /// </summary>
        /// <returns>The zone template.</returns>
        ...
        /// <summary>
        /// Calculates the obstruction envelope for the currently selected divider.
        /// </summary>
